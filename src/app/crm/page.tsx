      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <a href="/crm/executive" className="crm-button-primary justify-center">Dashboard Ejecutivo</a>
            <a href="/crm/inbox" className="crm-button-secondary justify-center">Inbox</a>
            <a href="/crm/automation" className="crm-button-secondary justify-center">Automation Center</a>
